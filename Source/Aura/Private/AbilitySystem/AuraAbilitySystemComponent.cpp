...
void UAuraAbilitySystemComponent::AddCharactersAbilities(const TArray<TSubclassOf<UGameplayAbility>>& StartupAbilities)
{
...
{
	// return if called before InputTag has a chance to initialize
