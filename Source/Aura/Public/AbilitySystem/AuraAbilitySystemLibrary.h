...
public:
	...
	static int32 GetXPReward(const UObject* WorldContextObject, ECharacterClass CharacterClass, int32 Level);
	...
	UFUNCTION(BlueprintPure, Category = "AuraAbilitySystemLibrary|GameMechanics")
